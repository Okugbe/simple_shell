...
/**
 * struct data - struct that contains all relevant data on the runtime
 * @av: Argument vector
 * @input: Command line written by the users
 * @args: Tokens of the command line
 * @status: Status of the shell
 * @counter: Lines counter of the shell
 ...
 * @line: Command lines of the shell
 * @next: Next node
 ...
 * @len_val: Length of value of the variables
 * @next: Next node
